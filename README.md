# Darween ERP - Frontend Application

A professional ERP frontend built with React, TanStack Router, TanStack Query, and Shadcn UI.

## Features

- 🔐 **Authentication** - Secure login/register with JWT
- 🏢 **Companies Management** - Full CRUD for companies
- 📦 **Products & Variants** - Manage products with multiple variants
- 📊 **Inventory Tracking** - Stock management and adjustments
...
See [IMPLEMENTATION.md](./IMPLEMENTATION.md) for complete documentation including:
